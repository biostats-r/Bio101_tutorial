...
I denne tutorial skal vi bruke **tidyverse** pakken og vi laster denne pakken med funksjonen `library()`:

```{r load-libs, eval = FALSE, echo=TRUE}
library("tidyverse")
...
I øvelsen i denne praksisdelen skal du bruke en Rmarkdown til å skrive rapporten.
En RMarkdown fil kan inneholde både tekst og kode og du kan direkte plotte tabeller og figurer.

Se denne video for en kort inforing i RMarkdown:
https://www.youtube.com/watch?v=EqJiAlJAl8Y&list=PLA2iRWVwbpTIweEBHD2dOKjZHK1atRmXt&index=7
